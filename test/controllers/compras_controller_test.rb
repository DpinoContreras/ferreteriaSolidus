...
class ComprasControllerTest < ActionController::TestCase
  ...
  test "should create compra" do
    assert_difference('Compra.count') do
      post :create, compra: { Cliente_id: @compra.Cliente_id, fecha: @compra.fecha, precioTotal: @compra.precioTotal }
    end
  ...
  test "should update compra" do
    patch :update, id: @compra, compra: { Cliente_id: @compra.Cliente_id, fecha: @compra.fecha, precioTotal: @compra.precioTotal }
    assert_redirected_to compra_path(assigns(:compra))
  end
