...
class UbicacionsControllerTest < ActionController::TestCase
  ...
  test "should create ubicacion" do
    assert_difference('Ubicacion.count') do
      post :create, ubicacion: { comunaUbicacion: @ubicacion.comunaUbicacion, direccionUbicacion: @ubicacion.direccionUbicacion }
    end
  ...
  test "should update ubicacion" do
    patch :update, id: @ubicacion, ubicacion: { comunaUbicacion: @ubicacion.comunaUbicacion, direccionUbicacion: @ubicacion.direccionUbicacion }
    assert_redirected_to ubicacion_path(assigns(:ubicacion))
  end
