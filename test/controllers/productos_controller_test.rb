...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { codigoProducto: @producto.codigoProducto, descripcion: @producto.descripcion, nombre: @producto.nombre, precioCompra: @producto.precioCompra, stock: @producto.stock }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { codigoProducto: @producto.codigoProducto, descripcion: @producto.descripcion, nombre: @producto.nombre, precioCompra: @producto.precioCompra, stock: @producto.stock }
    assert_redirected_to producto_path(assigns(:producto))
  end
